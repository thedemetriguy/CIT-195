namespace assignment8ex1
{
    class Program
    {
        ...
        public delegate void ChorusVerse();
        ...
        static void Main(string[] args)
        {
            ...
            Program.ChorusVerse chorusVerseObj = new Program.ChorusVerse(HereComesTheSun.chorus);
            // adding methods to the delegate
            chorusVerseObj += HereComesTheSun.chorus2;
            chorusVerseObj += HereComesTheSun.verse1;
            chorusVerseObj += HereComesTheSun.verse2;
            chorusVerseObj += HereComesTheSun.verse3;
            chorusVerseObj += HereComesTheSun.end;
